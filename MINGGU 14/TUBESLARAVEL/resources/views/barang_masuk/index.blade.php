            ...
            <div class="modal-content">
                ...
                <form method="POST" action="{{ route('barangMasuk.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="text" name="deskripsi" id="deskripsi" placeholder="Deskripsi" class="form-control mb-2" required>
                        <input type="number" name="jumlah" id="jumlah" placeholder="Jumlah Barang" class="form-control mb-2" required>
                        <div class="form-group">
