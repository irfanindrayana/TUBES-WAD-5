                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" class="btn btn-warning" data-toggle="modal"
                                    data-target="#edit{{ $index->id }}">Edit</button>
                                <button type="button" class="btn btn-danger" data-toggle="modal"
                                    data-target="#delete{{ $index->id }}">Hapus</button>
                                </form>
                            </td>
                        </tr>
                    @endforeach
                                ...
                                <div class="modal-content">
                                    ...
                                    <form method="POST" action="{{ route('home.update', $item->id) }}">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <input type="text" name="namaBarang" value="{{ $item->namaBarang }}"
                    ...
                    <form method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <input type="text" name ="deskripsi" placeholder="Deskripsi Barang" class="form-control"
                                required><br>
                            <input type="number" name ="stok" placeholder="Jumlah Barang" class="form-control"
                                required><br>
