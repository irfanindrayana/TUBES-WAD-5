    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="alert alert-danger alert-dismissible">
                ...
                <strong>PERHATIAN!</strong> Stok <strong><?php echo e($item->namaBarang); ?></strong> saat ini (<?php echo e($item->stok); ?>) telah mencapai batas minimal (<?php echo e($item->stok_minimal); ?>).
            </div>
                ...
                <table id="datatablesSimple" class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo e(route('home.detail', $index->id)); ?>" 
                                   class="text-decoration-none text-dark font-weight-bold">
                                    <?php echo e($index->namaBarang); ?>
